...
<div class="space-y-8">
	...
	<div class="space-y-2">
		<div class="mb-2 flex items-center gap-2 font-spacemono text-sm text-muted-foreground">
			...
			<span>/</span>
			<a href="/heading" class="transition-colors hover:text-kleri-green-2">Heading</a>
			<span>/</span>
			<span class="text-foreground">SecondaryHeading</span>
		</div>
		<h1 class="text-4xl font-bold text-foreground">SecondaryHeading</h1>
	...
	<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
		...
		<div class="space-y-4 lg:col-span-2">
			...
			<CodePreview component="SecondaryHeading" {props} />
		</div>
